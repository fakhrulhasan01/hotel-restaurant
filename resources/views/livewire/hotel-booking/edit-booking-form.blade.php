<div>
    <div class="p-4 bg-white dark:bg-gray-800">
        <div class="mb-4">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Edit Booking</h1>
        </div>
        ...
        <form wire:submit="submitForm">
            ...
            <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-700 mb-6">
                <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Rooms</h3>

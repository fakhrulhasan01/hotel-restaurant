<div>
    <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px">
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=email' }}"
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=language' }}"
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=payment' }}"
              ...
              <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=theme' }}"
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=push' }}"
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=currency' }}"
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=storage' }}"
            ...
            <li class="me-2">
                <a href="{{ route('superadmin.superadmin-settings.index').'?tab=desktop-app' }}"

...
class Pos extends Component
{
    ...
    public function mount()
    {
        ...
        if ($this->orderID) {
            ...
            $order = Order::with(['table', 'extraCharges'])->find($this->orderID);
    ...
    public function addCartItems($id, $variationCount, $modifierCount)
    {
        ...
        // Contextually eager load item with price relationships to avoid N+1 queries
        $this->menuItem = MenuItem::with([
    ...
    public function menuItems()
    {
        ...
        $query = $query->search('item_name', $this->search)->take($this->menuItemsLoaded)->get();
